...
#To close the plot it is important to add an "extra" level of variable which needs the same value as the level 1. Both factors ("A" and "B") need this correction.
